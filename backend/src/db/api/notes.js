...
module.exports = class NotesDBApi {
  static async create(data, options) {
    ...
    await notes.setRelated_lead(data.related_lead || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.related_lead = await notes.getRelated_lead({
      transaction,
    });
